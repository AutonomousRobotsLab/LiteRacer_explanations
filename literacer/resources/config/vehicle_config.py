...
from literacer.resources.config.env_config import track_drv_func
from literacer.utils.enums import SensingFreq
...
controller_model_path = 'literacer/resources/controller_models/2b' # may use None for training mode (will not load a controller)
...
### sensor config
sensing_freq = SensingFreq.ON_REQUEST #SensingFreq.CONTINUOUS #Sensing.ON_REQUEST # the frequency in which sensing is invoked
