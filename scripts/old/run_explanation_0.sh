...
#SBATCH --job-name run_explanation_0 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_explanation_0.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/LiteRacer/bin/python ~/repos/CausalityFalsificationLiteRacer/explanation.py -C 0