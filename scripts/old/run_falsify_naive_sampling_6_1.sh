...
#SBATCH --job-name run_falsify_naive_sampling_6_1 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_falsify_naive_sampling_6_1.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/LiteRacer/bin/python ~/repos/CausalityFalsificationLiteRacer/falsify_naive_sampling.py -N 3000 -O 6 -R 0.1